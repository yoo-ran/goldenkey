  ...
  return (
    <header className='font-head w-full z-50'>
      <nav className='flexCol lg:py-5 relative'>
        <ul
          className={`w-full absolute divide-y-[0.1rem] divide-secondary flexCol text-center mobile_3_bold justify-around gap-x-4 bg-primary transition-[all] ${
            open ? ' top-14' : '-top-52'
          }`}
        >
          <li
            className={`w-full py-5  transition-all ${
              location.pathname === '/favorite'
                ? 'text-primary-yellow lg:text-primary bg-secondary lg:bg-primary-yellow'
                : 'text-primary-yellow'
            }`}
          >
            <Link to='/'>홈</Link>
          ...
          <li
            className={`w-full py-5 transition-all ${
              location.pathname === '/importExcel'
                ? 'text-primary-yellow lg:text-primary bg-secondaryylg:bg-primary-yellow'
                : 'text-primary-yellow'
            }`}
          >
        ...
        <div className='py-5 px-5 flexRow justify-between w-full z-50 bg-white'>
          <div className='w-8/12 h-5 relative' onClick={() => setOpen(!open)}>
            <p
          ...
          <button className='hover:bg-navy transition-all bg-primary-yellow text-primary px-4 lg:py-2 rounded-lg'>
